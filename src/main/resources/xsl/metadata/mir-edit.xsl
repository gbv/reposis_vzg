...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation"
  ...
  xmlns:mods="http://www.loc.gov/mods/v3" exclude-result-prefixes="i18n mcrxml mods">
  <xsl:import href="xslImport:modsmeta:metadata/mir-edit.xsl" />
  <!-- TODO: resolve dependencies -->
  <xsl:include href="mods.xsl" />
  <xsl:template match="/">
    <!-- VZG: action menu is restricted to admins, all other roles work via the workflow box -->
